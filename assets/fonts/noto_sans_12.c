 ...
 * Size: 12 px
 * Bpp: 4
 * Opts: --font assets/fonts/NotoSans-Regular.ttf --size 12 --bpp 4 --format lvgl --range 0x20-0x7F,0xA2-0xA5,0xA7,0xA9,0xAE,0xB0-0xB2,0xB5,0xB6,0xD7,0xF7,0x2013-0x2014,0x2018-0x201D,0x2022,0x2026,0x2122,0x20AC --no-compress -o assets/fonts/noto_sans_12.c
 ******************************************************************************/
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 2757, .adv_w = 67, .box_w = 4, .box_h = 6, .ofs_x = 0, .ofs_y = 5},
    {.bitmap_index = 2769, .adv_w = 120, .box_w = 6, .box_h = 10, .ofs_x = 1, .ofs_y = -3},
    {.bitmap_index = 2799, .adv_w = 126, .box_w = 7, .box_h = 12, .ofs_x = 0, .ofs_y = -2},
    {.bitmap_index = 2841, .adv_w = 110, .box_w = 7, .box_h = 7, .ofs_x = 0, .ofs_y = 1},
    {.bitmap_index = 2866, .adv_w = 110, .box_w = 7, .box_h = 6, .ofs_x = 0, .ofs_y = 2},
    {.bitmap_index = 2887, .adv_w = 96, .box_w = 6, .box_h = 1, .ofs_x = 0, .ofs_y = 3},
    {.bitmap_index = 2890, .adv_w = 192, .box_w = 12, .box_h = 1, .ofs_x = 0, .ofs_y = 3},
    {.bitmap_index = 2896, .adv_w = 34, .box_w = 2, .box_h = 4, .ofs_x = 0, .ofs_y = 5},
    {.bitmap_index = 2900, .adv_w = 34, .box_w = 2, .box_h = 4, .ofs_x = 0, .ofs_y = 5},
    {.bitmap_index = 2904, .adv_w = 48, .box_w = 3, .box_h = 4, .ofs_x = 0, .ofs_y = -2},
    {.bitmap_index = 2910, .adv_w = 34, .box_w = 2, .box_h = 4, .ofs_x = 0, .ofs_y = 5},
    {.bitmap_index = 2914, .adv_w = 69, .box_w = 5, .box_h = 4, .ofs_x = 0, .ofs_y = 5},
    {.bitmap_index = 2924, .adv_w = 69, .box_w = 5, .box_h = 4, .ofs_x = 0, .ofs_y = 5},
    {.bitmap_index = 2934, .adv_w = 72, .box_w = 4, .box_h = 4, .ofs_x = 0, .ofs_y = 3},
    {.bitmap_index = 2942, .adv_w = 152, .box_w = 9, .box_h = 2, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 2951, .adv_w = 110, .box_w = 7, .box_h = 9, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 2983, .adv_w = 148, .box_w = 9, .box_h = 5, .ofs_x = 0, .ofs_y = 4}
};
