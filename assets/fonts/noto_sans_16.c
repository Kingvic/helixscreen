 ...
 * Size: 16 px
 * Bpp: 4
 * Opts: --font assets/fonts/NotoSans-Regular.ttf --size 16 --bpp 4 --format lvgl --range 0x20-0x7F,0xA2-0xA5,0xA7,0xA9,0xAE,0xB0-0xB2,0xB5,0xB6,0xD7,0xF7,0x2013-0x2014,0x2018-0x201D,0x2022,0x2026,0x2122,0x20AC --no-compress -o assets/fonts/noto_sans_16.c
 ******************************************************************************/
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 4613, .adv_w = 90, .box_w = 5, .box_h = 7, .ofs_x = 0, .ofs_y = 7},
    {.bitmap_index = 4631, .adv_w = 159, .box_w = 8, .box_h = 13, .ofs_x = 1, .ofs_y = -4},
    {.bitmap_index = 4683, .adv_w = 168, .box_w = 9, .box_h = 15, .ofs_x = 0, .ofs_y = -3},
    {.bitmap_index = 4751, .adv_w = 146, .box_w = 8, .box_h = 8, .ofs_x = 1, .ofs_y = 2},
    {.bitmap_index = 4783, .adv_w = 146, .box_w = 9, .box_h = 8, .ofs_x = 0, .ofs_y = 2},
    {.bitmap_index = 4819, .adv_w = 128, .box_w = 8, .box_h = 3, .ofs_x = 0, .ofs_y = 3},
    {.bitmap_index = 4831, .adv_w = 256, .box_w = 16, .box_h = 3, .ofs_x = 0, .ofs_y = 3},
    {.bitmap_index = 4855, .adv_w = 45, .box_w = 3, .box_h = 5, .ofs_x = 0, .ofs_y = 7},
    {.bitmap_index = 4863, .adv_w = 45, .box_w = 3, .box_h = 5, .ofs_x = 0, .ofs_y = 7},
    {.bitmap_index = 4871, .adv_w = 64, .box_w = 3, .box_h = 5, .ofs_x = 0, .ofs_y = -2},
    {.bitmap_index = 4879, .adv_w = 45, .box_w = 3, .box_h = 5, .ofs_x = 0, .ofs_y = 7},
    {.bitmap_index = 4887, .adv_w = 92, .box_w = 6, .box_h = 5, .ofs_x = 0, .ofs_y = 7},
    {.bitmap_index = 4902, .adv_w = 92, .box_w = 6, .box_h = 5, .ofs_x = 0, .ofs_y = 7},
    {.bitmap_index = 4917, .adv_w = 96, .box_w = 4, .box_h = 5, .ofs_x = 1, .ofs_y = 4},
    {.bitmap_index = 4927, .adv_w = 202, .box_w = 11, .box_h = 3, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 4944, .adv_w = 146, .box_w = 9, .box_h = 12, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 4998, .adv_w = 198, .box_w = 12, .box_h = 7, .ofs_x = 0, .ofs_y = 5}
};
