 ...
 * Size: 20 px
 * Bpp: 4
 * Opts: --font assets/fonts/NotoSans-Regular.ttf --size 20 --bpp 4 --format lvgl --range 0x20-0x7F,0xA2-0xA5,0xA7,0xA9,0xAE,0xB0-0xB2,0xB5,0xB6,0xD7,0xF7,0x2013-0x2014,0x2018-0x201D,0x2022,0x2026,0x2122,0x20AC --no-compress -o assets/fonts/noto_sans_20.c
 ******************************************************************************/
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 6703, .adv_w = 112, .box_w = 7, .box_h = 9, .ofs_x = 0, .ofs_y = 8},
    {.bitmap_index = 6735, .adv_w = 199, .box_w = 10, .box_h = 16, .ofs_x = 1, .ofs_y = -5},
    {.bitmap_index = 6815, .adv_w = 210, .box_w = 10, .box_h = 18, .ofs_x = 1, .ofs_y = -3},
    {.bitmap_index = 6905, .adv_w = 183, .box_w = 10, .box_h = 10, .ofs_x = 1, .ofs_y = 2},
    {.bitmap_index = 6955, .adv_w = 183, .box_w = 10, .box_h = 10, .ofs_x = 1, .ofs_y = 2},
    {.bitmap_index = 7005, .adv_w = 160, .box_w = 10, .box_h = 2, .ofs_x = 0, .ofs_y = 5},
    {.bitmap_index = 7015, .adv_w = 320, .box_w = 20, .box_h = 2, .ofs_x = 0, .ofs_y = 5},
    {.bitmap_index = 7035, .adv_w = 56, .box_w = 4, .box_h = 5, .ofs_x = 0, .ofs_y = 9},
    {.bitmap_index = 7045, .adv_w = 56, .box_w = 4, .box_h = 5, .ofs_x = 0, .ofs_y = 9},
    {.bitmap_index = 7055, .adv_w = 80, .box_w = 4, .box_h = 5, .ofs_x = 0, .ofs_y = -3},
    {.bitmap_index = 7065, .adv_w = 56, .box_w = 4, .box_h = 5, .ofs_x = 0, .ofs_y = 9},
    {.bitmap_index = 7075, .adv_w = 115, .box_w = 7, .box_h = 5, .ofs_x = 0, .ofs_y = 9},
    {.bitmap_index = 7093, .adv_w = 115, .box_w = 7, .box_h = 5, .ofs_x = 0, .ofs_y = 9},
    {.bitmap_index = 7111, .adv_w = 120, .box_w = 5, .box_h = 5, .ofs_x = 1, .ofs_y = 5},
    {.bitmap_index = 7124, .adv_w = 253, .box_w = 14, .box_h = 3, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 7145, .adv_w = 183, .box_w = 12, .box_h = 14, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 7229, .adv_w = 247, .box_w = 14, .box_h = 8, .ofs_x = 0, .ofs_y = 7}
};
